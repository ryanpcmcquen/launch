#!/usr/bin/env python3
# Increment versions by ryanpcmcquen.
# For use with semantic versioning (MAJOR.MINOR.PATCH).
...
parser = argparse.ArgumentParser(
    description='Given the file _VERSION_.py with a VERSION variable set to ' +
    'MAJOR.MINOR.PATCH (string), this script will calculate increments for ' +
    'semantic versioning.'
)
